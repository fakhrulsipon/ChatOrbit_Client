  ...
  return (
    <div className="my-8 lg:my-12 xl:my-16 px-4 md:px-12 lg:px-8 xl:px-16">
      ...
      <div className="max-w-2xl mx-auto text-center mb-8">
        <h2 className="text-3xl font-bold mb-4 text-black">Getting Started with ChatOrbit</h2>
      ...
      <div className=" space-y-4">
        <div className="collapse collapse-arrow bg-base-100 border border-base-300 border-none">
          <input type="radio" name="faq-accordion" defaultChecked />
          <div className="collapse-title font-semibold bg-white text-black">
            How do I create an account on ChatOrbit?
          </div>
          <div className="collapse-content text-sm bg-white text-black">
