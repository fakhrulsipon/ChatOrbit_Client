...
const About = () => {
  return (
    <div className="min-h-screen my-8 lg:my-12 xl:my-16 px-4 md:px-12 lg:px-8 xl:px-16 flex flex-col items-center space-y-20">
      {/* Page Title */}
      <h1 className="md:text-4xl text-3xl font-semibold text-gray-800 text-center mb-10">
        About Our Community
      </h1>

      {/* Section 1: Mission */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-12 hover:shadow-2xl transition-shadow duration-300">
        <h2 className="md:text-3xl text-2xl font-semibold mb-6 text-blue-600">Our Mission</h2>
      ...
      {/* Section 2: Vision */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-12 hover:shadow-2xl transition-shadow duration-300">
        <h2 className="md:text-3xl text-2xl font-semibold mb-6 text-blue-600">Our Vision</h2>
        <p className="text-gray-700 leading-relaxed text-lg">
      ...
      {/* Section 3: Team */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-12 hover:shadow-2xl transition-shadow duration-300">
        <h2 className="md:text-3xl text-2xl font-semibold mb-6 text-blue-600">Our Team</h2>
        <p className="text-gray-700 leading-relaxed text-lg">
      ...
      <section className="w-full max-w-6xl flex flex-col items-center space-y-12">
        <h2 className="md:text-4xl text-3xl font-semibold text-blue-600 mb-8 text-center">Why Join Our Community?</h2>
